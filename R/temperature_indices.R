...
#'
#' @export
climdex.tn10p <- function(ci, freq = c("monthly", "annual", "seasonal")) {
...
#'
#' @export
climdex.tx10p <- function(ci, freq = c("monthly", "annual", "seasonal")) {
...
#'
#' @export
climdex.tn90p <- function(ci, freq = c("monthly", "annual", "seasonal")) {
  stopifnot(!is.null(ci@data$tmin) && !is.null(ci@quantiles$tmin))
...
#'
#' @export
climdex.tx90p <- function(ci, freq = c("monthly", "annual", "seasonal")) {
  stopifnot(!is.null(ci@data$tmax) && !is.null(ci@quantiles$tmax))
...
#'
#' @export
climdex.dtr <- function(ci, freq = c("monthly", "annual", "seasonal")) {
  stopifnot(!is.null(ci@data$tmin) && !is.null(ci@data$tmax) && !is.null(ci@data$tavg))
  return(compute.mean.daily.temp.range(ci@data$tmax, ci@data$tmin, ci@date.factors[[match.arg(freq)]]) * ci@namasks[[match.arg(freq)]]$tavg)
}
